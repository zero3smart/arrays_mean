...
var index_controller = require('../app/controllers/client/data_preparation');
...
var gallery_controller = require('../app/controllers/client/data_preparation/gallery');
var chart_controller = require('../app/controllers/client/data_preparation/chart');
var line_graph_controller = require('../app/controllers/client/data_preparation/line_graph');
var scatterplot_controller = require('../app/controllers/client/data_preparation/scatterplot');
var choropleth_controller = require('../app/controllers/client/data_preparation/choropleth');
var timeline_controller = require('../app/controllers/client/data_preparation/timeline');
var word_cloud_controller = require('../app/controllers/client/data_preparation/word_cloud');
var bar_chart_controller = require('../app/controllers/client/data_preparation/bar_chart');
var pie_set_controller = require('../app/controllers/client/data_preparation/pie_set');
...
var object_details_controller = require('../app/controllers/client/data_preparation/object_details');
