...
[
    ...
    },
    {
            ...
            fe_excludeFields: 
            [
                "ID", // not sure if we really want to exclude this
                //
                // "imgURL_original", 
                // "imgURL_gridThumb"
            ],
    ...
    //
    // Production - Visible - Total Workplaces by State 2013
    // {
    //     filename: "us_state_totals_2013.csv",
    //     fileEncoding: "utf8", // the default
    //     uid: "total_workplaces_by_state_2013",
    //     importRevision: 1,
    //     format: import_datatypes.DataSource_formats.CSV,
    //     title: "U.S. Firms & Establishments, 2013",
    //     urls: [ "http://www.census.gov/econ/susb/" ],
    //     description: "Number of Firms, Number of Establishments, Employment, and Annual Payroll by Enterprise Employment Size for the United States and States, Totals: 2013",
    //     //
    //     //
    //     fn_new_rowPrimaryKeyFromRowObject: function(rowObject, rowIndex)
    //     {
    ...
    //     fe_designatedFields: 
    //     {
    //         objectTitle: "Geographic Area Description",
    //         originalImageURL: null, // not strictly necessary to define as null but done for explicitness
    //         medThumbImageURL: null // not strictly necessary to define as null but done for explicitness
    //     },
    //     fe_excludeFields: 
    ...
    //     fe_filters_fieldsNotAvailable:
    //     [
    //         "ID", // because they're effectively unique
    //         "FIPS Code",
    //         "Number of Firms",
    ...
    //     // },
    //     //
    //     fe_chart_defaultGroupByColumnName_humanReadable: "Geographic Area Description",
    //     fe_chart_fieldsNotAvailableAsGroupByColumns:
    //     [
    //         "ID", // because they're effectively unique
    //         "FIPS Code"
    ...
    //     //
    //     //
    //     fe_choropleth_defaultMapByColumnName_humanReadable: "Geographic Area Description",
    //     fe_choropleth_fieldsNotAvailableAsMapByColumns:
    //     [
    //         "ID", // because they're effectively unique
    //         "FIPS Code",
