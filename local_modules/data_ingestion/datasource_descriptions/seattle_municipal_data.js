    ...
    [
        {
            ...
            uid: "municipal_news_data",
            importRevision: 1,
            format: import_datatypes.DataSource_formats.CSV,
            title: "Seattle Municipal News",
            brandColor: "#6699CC",
            ...
            raw_rowObjects_coercionScheme:
            {
                'Date': {
                    ...
                    opts: {
                        format: "MM/DD/YYYY" // e.g. "03-21-09"
                    }
                },
                'Date created': {
                    do: import_datatypes.Coercion_ops.ToDate,
                    opts: {
                        format: "MM/DD/YY"  // e.g. "03-21-09"
                    }
                },
                'Date modified': {
                    do: import_datatypes.Coercion_ops.ToDate,
            ...
            fn_new_rowPrimaryKeyFromRowObject: function(rowObject, rowIndex)
            {
                ...
                fn_new_rowPrimaryKeyFromRowObject: function(rowObject, rowIndex)
            {
                return "" + rowIndex + "-" + rowObject["Title"]
            },
            fe_designatedFields:
            {
                objectTitle: "Title",
                   ...
                   
            {
                        ...
                        //
                        // Detect if the row is an issue or page by primary key - Title
                        if (rowDoc.rowParams.Title && rowDoc.rowParams.Title != '') {
                            // Issue
