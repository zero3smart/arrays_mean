...
module.exports.sendVizFinishProcessingEmail = function(user,dataset,team,cb) {
	...
	if (default_view !== undefined) {
		var datasetLink = protocol + team.subdomain + '.' + rootDomain + '/' + dataset.uid + '-r' + dataset.importRevision + '/' + default_view;
		htmlText += '<br>You can view your dataset here: ' +  datasetLink;
	} else {
		var datasetLink = protocol + 'app.' + rootDomain +  '/dashboard/dataset/views/' + dataset._id ;
