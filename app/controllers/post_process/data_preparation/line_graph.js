...
module.exports.BindData = function (req, urlQuery, callback) {
    ...
    if (typeof dataSourceDescription.fe_views !== 'undefined' && dataSourceDescription.fe_views.lineGraph != true) {
        ...
        var doneFn = function (err, _multigroupedResults) {
            ...
            _.forOwn(_multigroupedResults_object, function(_groupedResults, stack) {
                ...
                if (!Array.isArray(stackedResultsByGroup)) {
                    ...
                    _.forEach(Object.keys(stackedResultsByGroup).sort(), function (key) {
