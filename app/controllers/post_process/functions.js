...
//
constructor.prototype._routePathByAppendingQueryStringToVariationOfBase = function(routePath_variation, queryString, routePath_base)
{
...
//
constructor.prototype._urlQueryByAppendingQueryStringToExistingQueryString = function(existingQueryString, queryStringToAppend)
{
...
//
constructor.prototype._activeFilter_matchOp_orErrDescription_fromMultiFilter = function(dataSourceDescription, filterObj)
{
    ...
    for (var i = 0 ; i < filterCols_length ; i++) {
        ...
        for (var j = 0 ; j < filterVals_length ; j++) {
            ...
            if (typeof filterVal === 'string') {
                matchConditions = this._activeFilter_matchCondition_orErrDescription(dataSourceDescription, filterCol, filterVal);
            } else if (filterVal.min !== null || filterVal.max !== null) {
                matchConditions = this._activeFilterRange_matchCondition_orErrDescription(dataSourceDescription, filterCol, filterVal.min, filterVal.max);
            } else {
...
//
constructor.prototype._activeFilter_matchCondition_orErrDescription = function(dataSourceDescription, filterCol, filterVal)
{
    ...
    if (isAFabricatedFilter == true) { // already obtained matchConditions just above
        ...
        if (!isDate) {
            ...
            matchConditions = this._activeSearch_matchOp_orErrDescription(dataSourceDescription, realColumnName, realFilterValue).matchOps;

        } else {
            matchConditions = this._activeSearch_matchOp_orErrDescription(dataSourceDescription, realColumnName, filterVal).matchOps;
        }
    }
    if (typeof matchConditions === 'undefined') {
...
//
constructor.prototype._activeFilterRange_matchCondition_orErrDescription = function(dataSourceDescription, filterCol, filterValMin, filterValMax)
{
    var realColumnName = importedDataPreparation.RealColumnNameFromHumanReadableColumnName(filterCol, dataSourceDescription);
    var realColumnName_path = "rowParams." + realColumnName;
...
//
constructor.prototype._activeSearch_matchOp_orErrDescription = function(dataSourceDescription, searchCol, searchQ)
...
//
constructor.prototype._topUniqueFieldValuesForFiltering = function(source_pKey, dataSourceDescription, sampleDoc, callback)
{
...
//
constructor.prototype._reverseDataTypeCoersionToMakeFEDisplayableValFrom = function(originalVal, key, dataSourceDescription)
{
...
//
constructor.prototype._new_truesByFilterValueByFilterColumnName_forWhichNotToOutputColumnNameInPill = function (dataSourceDescription)
{
...
//
constructor.prototype._new_reconstructedURLEncodedFilterObjAsFilterJSONString = function(filterObj)
{
